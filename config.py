...
AD_FORMATS: dict[str, dict] = {
    ...
    "promo": {
        ...
        "details": [
            ...
            "Telegram-пост",
            "присутствие в Telegram-канале 2 месяца",
            "адаптация подачи под аудиторию",
        ],
        "who": "услугам, экспертам, локальным бизнесам и проектам",
        "options": [{"key": "std", "label": "2 месяца", "price": "180.00"}],
    },
    "afisha": {
        "name": "Афиша", "badge": "",
        "lead": "Анонс события в Instagram.",
        "details": [
            "размещение в афише / подборке мероприятий",
    ...
    "afisha_plus": {
        ...
        "lead": "Анонс события в Instagram и в Telegram-боте.",
        "details": [
            "всё из «Афиши»",
            "публикация в Instagram + Telegram-бот",
            "дополнительная сторис-поддержка",
            "ссылка на билеты или регистрацию",
        ],
        "who": "событиям, где важны продажи билетов и регистрация",
        "options": [{"key": "std", "label": "Instagram + Telegram", "price": "65.00"}],
    },
}
