...
# key -> название, цена (строкой, вкл. BTW), краткое описание, бейдж.
AD_FORMATS: dict[str, dict] = {
    "expert": {
        "name": "Эксперт месяца", "price": "99.00", "badge": "⭐ Рекомендуем",
        "lead": "Постоянное присутствие и поток клиентов из поиска в боте. Абонемент.",
    },
    "promo": {
        "name": "Продвижение", "price": "150.00", "badge": "Популярное",
        "lead": "Кампания на 2 месяца: серия нативных касаний в Instagram и Telegram.",
    },
    "afisha": {
        "name": "Афиша", "price": "50.00", "badge": "",
        "lead": "Короткий формат для мероприятий, концертов, экскурсий и встреч.",
    },
    "afisha_plus": {
        "name": "Афиша+", "price": "79.00", "badge": "Расширенный",
        "lead": "Для событий, где важны продажи билетов и регистрация.",
    },
}
