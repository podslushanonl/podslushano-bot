...
# Расписание прогулок. key — устойчивый идентификатор, его нельзя переиспользовать.
# capacity — число оплачиваемых гостевых мест (организатор в него не входит).
ALLO_WALKS: list[dict] = [
    {
        ...
        "capacity": 8, "desc": ("Wandelroute Ooijpolder (7,5 км): река Waal, "
                 "пойменные луга, коники, старые кирпичные заводы и виды."),
    },
    {
        "key": "2026-09-13-bbq", "starts_at": "2026-09-13T12:00:00+02:00",
        "status": "waitlist", "date": "13 сентября · воскресенье · 12:00",
        "title": "Закрытие лета: прогулка и BBQ", "short_title": "Закрытие лета",
        "place": "Máximapark · Utrecht", "meet": "Utrecht Leidsche Rijn · 12:00",
        "finish": "Máximapark · около 18:00", "dur": "≈6 часов", "distance": "≈6 км",
        "price": "49.00", "capacity": 10, "min_participants": 6,
        "tag": "BBQ + прогулка", "tone": "lime", "format": "special",
        "desc": ("Провожаем лето своей компанией: сначала неспешно проходим парк, "
                 "затем устраиваем большой общий BBQ и остаёмся общаться без спешки."),
        "program": [
            ["12:00", "Встречаемся", "Знакомимся у станции и проверяем, всё ли взяли."],
            ["12:20", "Маршрут по Máximapark", "Около 6 км через Het Lint, Castellum и Vlinderhof."],
            ["14:15", "Большой BBQ", "Мясо, овощи, соусы, хлеб и безалкогольные напитки."],
            ["17:30", "Закрываем лето", "Общее фото, уборка площадки и путь к станции."],
        ],
        "included": ["маршрут и сопровождение", "мясо и вегетарианская альтернатива",
                     "овощи, хлеб, соусы и снеки", "вода и безалкогольные напитки",
                     "гриль, уголь, посуда и уборка"],
        "not_included": ["алкоголь", "проезд до Utrecht Leidsche Rijn"],
        "bring": ["удобную обувь", "одежду по погоде", "плед по желанию",
                  "заранее сообщить об аллергиях и типе питания"],
        "rules": ["BBQ ставим над землёй и вдали от деревьев и кустов",
                  "после встречи полностью убираем площадку",
                  "при запрете из-за засухи переносим BBQ или меняем формат"],
        "weather": "При сильном дожде предложим новую дату или полный возврат.",
        "cancel_before_hours": 72, "pass_eligible": False,
        "route_url": "https://www.google.com/maps/dir/Utrecht+Leidsche+Rijn/M%C3%A1ximapark,+Utrecht/Vlinderhof,+Utrecht/Utrecht+Leidsche+Rijn",
        "directions_url": "https://www.google.com/maps/dir/?api=1&destination=Utrecht+Leidsche+Rijn",
        "map": {"center": [52.101, 5.038], "zoom": 13,
                "points": [[52.098, 5.066], [52.105, 5.037], [52.099, 5.026], [52.098, 5.066]]},
    },
    {
        "key": "2026-09-19-oysters", "starts_at": "2026-09-19T11:00:00+02:00",
        "status": "waitlist", "date": "19 сентября · суббота · 11:00",
        "title": "За устрицами в Зеландию", "short_title": "Устрицы в Зеландии",
        "place": "Yerseke · Zeeland", "meet": "Oss Centraal · 11:00",
        "finish": "Oss Centraal · около 19:30", "dur": "≈8,5 часов", "distance": "≈4 км",
        "price": "59.00", "capacity": 7, "min_participants": 5,
        "tag": "Море + поездка", "tone": "blue", "format": "special",
        "desc": ("Едем небольшим бусом к Oosterschelde, гуляем по дамбе и во время "
                 "отлива собираем диких устриц для личного использования."),
        "program": [
            ["11:00", "Выезд из Oss", "Знакомимся и едем вместе в Yerseke."],
            ["13:15", "Побережье Oosterschelde", "Инструктаж, прогулка и поиск безопасного участка."],
            ["14:30", "Сбор во время отлива", "Собираем вручную, не заходим на илистые отмели."],
            ["17:00", "Yerseke", "Свободное время; сертифицированная дегустация — по желанию."],
            ["19:30", "Возвращение в Oss", "Время может немного измениться из-за дороги и воды."],
        ],
        "included": ["место в общем транспорте из Oss и обратно", "сопровождение и инструктаж",
                     "общие вёдра и термобокс", "проверка прилива за 48 часов"],
        "not_included": ["еда и напитки", "платная дегустация в Yerseke",
                         "личные перчатки и резиновые сапоги"],
        "bring": ["резиновые сапоги", "плотные порезостойкие перчатки",
                  "ветро- и влагозащитную одежду", "воду и перекус", "небольшую личную ёмкость"],
        "rules": ["не более 10 кг на человека и только для себя",
                  "собираем вручную у подножия доступной дамбы",
                  "не заходим на отмели, не копаем грунт и не тревожим птиц",
                  "дикие устрицы едят на свой риск; для дегустации рекомендуем сертифицированные"],
        "weather": "Маршрут зависит от ветра и воды; при небезопасных условиях переносим поездку.",
        "cancel_before_hours": 168, "pass_eligible": False,
        "route_url": "https://www.google.com/maps/dir/Oss+Centraal/Yerseke/Oss+Centraal",
        "directions_url": "https://www.google.com/maps/dir/?api=1&destination=Oss+Centraal",
        "map": {"center": [51.505, 4.05], "zoom": 8,
                "points": [[51.765, 5.532], [51.492, 4.05]]},
    },
    {
        "key": "2026-09-27-waterline", "starts_at": "2026-09-27T11:00:00+02:00",
        "status": "open", "date": "27 сентября · воскресенье · 11:00",
        "title": "Waterlinie и Bossche Broek", "short_title": "Vught → Den Bosch",
        "place": "Vught → ’s-Hertogenbosch", "meet": "Station Vught · 11:00",
        "finish": "Den Bosch Centraal · около 16:00", "dur": "≈5 часов", "distance": "≈10 км",
        "price": "35.00", "capacity": 10, "min_participants": 4,
        "tag": "Классическая прогулка", "tone": "orange", "format": "walk",
        "desc": ("Обычная Allo-прогулка в лучшем смысле: укрепления, зелёный Bossche "
                 "Broek, разговоры по дороге и финиш в центре Den Bosch."),
        "program": [["11:00", "Старт в Vught", "Знакомимся у станции и выходим на маршрут."],
                    ["12:15", "Lunetten и Fort Isabella", "История водной линии и короткая пауза."],
                    ["14:00", "Bossche Broek", "Пикник и самый зелёный участок маршрута."],
                    ["16:00", "Финиш в Den Bosch", "Кофе в центре — по желанию и за свой счёт."]],
        "included": ["продуманный линейный маршрут", "сопровождение группы",
                     "организационные сообщения и закрытый чат"],
        "not_included": ["поезд до Vught и обратно из Den Bosch", "еда и напитки"],
        "bring": ["удобную непромокаемую обувь", "воду и перекус", "дождевик"],
        "rules": ["темп разговорный, но нужно быть готовым пройти около 10 км",
                  "собаки возможны только на поводке и по предварительному согласованию"],
        "weather": "Небольшой дождь не отменяет прогулку; при штормовом предупреждении переносим.",
        "cancel_before_hours": 24, "pass_eligible": True,
        "route_url": "https://www.ns.nl/dagje-uit/wandelen/vughtse-lunetten.html",
        "directions_url": "https://www.google.com/maps/dir/?api=1&destination=Station+Vught",
        "map": {"center": [51.675, 5.306], "zoom": 12,
                "points": [[51.654, 5.291], [51.666, 5.303], [51.683, 5.315], [51.691, 5.294]]},
    },
    {
        "key": "2026-10-04-utrecht-boat", "starts_at": "2026-10-04T13:00:00+02:00",
        "status": "waitlist", "date": "4 октября · воскресенье · 13:00",
        "title": "Утрехт с воды", "short_title": "Лодка в Утрехте",
        "place": "Oudegracht · Utrecht", "meet": "Oudegracht 175W · 13:00",
        "finish": "центр Utrecht · около 16:30", "dur": "≈3,5 часа", "distance": "≈3 км пешком",
        "price": "39.00", "capacity": 10, "min_participants": 8,
        "tag": "Частная лодка", "tone": "violet", "format": "water",
        "desc": ("Только наша компания на лодке со шкипером: 90 минут по каналам, "
                 "а затем короткая прогулка по старому Utrecht."),
        "program": [["13:00", "Сбор на Oudegracht", "Приходим за 15 минут до отправления."],
                    ["13:15", "Частная прогулка", "90 минут на лодке со шкипером; есть крыша от дождя."],
                    ["15:00", "Старый Utrecht", "Идём по werfkelders и тихим улицам центра."],
                    ["16:30", "Финиш", "Можно остаться вместе на кофе или ранний ужин."]],
        "included": ["частная лодка на 90 минут", "профессиональный шкипер",
                     "крыша при дожде", "короткий городской маршрут и сопровождение"],
        "not_included": ["еда и напитки", "проезд до Utrecht"],
        "bring": ["тёплый слой одежды", "дождевик", "приходить минимум за 15 минут"],
        "rules": ["точное время подтверждаем после бронирования лодки",
                  "на борт нельзя опаздывать", "маршрут на воде определяет шкипер"],
        "weather": "Лодка имеет крышу; отмена возможна только при запрете выхода на воду.",
        "cancel_before_hours": 168, "pass_eligible": False,
        "route_url": "https://www.google.com/maps/search/?api=1&query=Oudegracht+175W+Utrecht",
        "directions_url": "https://www.google.com/maps/dir/?api=1&destination=Oudegracht+175W+Utrecht",
        "map": {"center": [52.09, 5.121], "zoom": 14,
                "points": [[52.09, 5.121], [52.096, 5.116], [52.101, 5.121], [52.09, 5.121]]},
    },
    {
        "key": "2026-10-11-bike-kromme-rijn", "starts_at": "2026-10-11T11:00:00+02:00",
        "status": "open", "date": "11 октября · воскресенье · 11:00",
        "title": "Велопрогулка вдоль Kromme Rijn", "short_title": "Kromme Rijn на велосипеде",
        "place": "Utrecht · Bunnik · Rhijnauwen", "meet": "Utrecht Centraal · 11:00",
        "finish": "Utrecht Centraal · около 16:30", "dur": "≈5,5 часов", "distance": "≈32 км",
        "price": "35.00", "capacity": 10, "min_participants": 4,
        "tag": "Easy ride", "tone": "green", "format": "bike",
        "desc": ("Спокойный круг вдоль Kromme Rijn через Amelisweerd, Rhijnauwen, "
                 "Fort Vechten и Bunnik. Не гонка: едем и разговариваем."),
        "program": [["11:00", "Проверяем велосипеды", "Знакомимся у Utrecht Centraal и обсуждаем сигналы."],
                    ["12:00", "Amelisweerd", "Зелёный участок вдоль воды."],
                    ["13:00", "Rhijnauwen", "Большая пауза на свой перекус или кафе."],
                    ["14:30", "Fort Vechten и Bunnik", "Возвращаемся в Utrecht спокойным темпом."],
                    ["16:30", "Финиш", "Заканчиваем у станции."]],
        "included": ["маршрут и навигация", "сопровождение группы", "закрытый чат участников"],
        "not_included": ["велосипед и его аренда", "еда и напитки", "ремонт и страховка"],
        "bring": ["исправный велосипед", "заряженный телефон и powerbank", "воду и перекус",
                  "запасную камеру/ремкомплект", "шлем настоятельно рекомендуем"],
        "rules": ["нужно уверенно ездить и знать базовые правила движения",
                  "электровелосипеды подходят, скорость держим общей",
                  "при поломке группа помогает безопасно добраться до ближайшей станции"],
        "weather": "При сильном ветре, грозе или ливне переносим и предлагаем возврат.",
        "cancel_before_hours": 24, "pass_eligible": True,
        "route_url": "https://www.routesinutrecht.nl/routes/3242871815/fietsroute-kromme-rijnstreek",
        "directions_url": "https://www.google.com/maps/dir/?api=1&destination=Utrecht+Centraal",
        "map": {"center": [52.072, 5.177], "zoom": 12,
                "points": [[52.089, 5.11], [52.079, 5.17], [52.064, 5.202], [52.067, 5.226], [52.089, 5.11]]},
    },
]
...
AD_FORMATS: dict[str, dict] = {
    ...
    "promo": {
        "name": "Продвижение", "badge": "−€30 · 7 дней",
        ...
        "options": [{"key": "std", "label": "4 выхода / 2 месяца", "price": "150.00",
