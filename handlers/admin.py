...
async def _legacy_export(message: Message) -> None:
    ...
    await message.answer(
        ...
        "<code>Здравствуйте! 🧡 Пишу вам лично от команды «Подслушано в Нидерландах».\n\n"
        ...
        "Хочу обратиться честно и заранее. Когда вы размещались, оплата была разовой. "
        "Но с тех пор гайд заметно вырос: мы перенесли его в бота, добавили удобный "
        ...
        "Понимаю, что менять условия — всегда неприятно, поэтому для вас, кто был с "
