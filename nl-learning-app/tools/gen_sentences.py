...
UNCNT={'мороженое','жильё','виноград','клубника','кожа','картофель','интернет','одежда','пиво','природа','рис','сахар','масло','мясо','лук','лимонад','музыка','морковь','вода','кофе','чай','хлеб','сыр','суп','колбаса','салат','погода'}
...
ADJ_SKIP={'злой','сердитый','больной','женатый','голодный','усталый','сытый','живой','старый','молодой','мёртвый','радостный','испуганный','довольный','весёлый','грустный','счастливый','занятой','оживлённый','свободный','целый','следующий','последний','первый','застенчивый','полосатый','клетчатый','однотонный','широкий','самостоятельный','присутствующий','отсутствующий','проснувшийся','непослушный','рождённый','помолвленный','разведённый','одинокий','двуязычный','гибкий','готовый'}
NEED_SKIP={'страна','сторона','провинция','север','юг','запад','восток','остров','деревня','город','лес','море','пляж','природа','погода','солнце','ветер','дождь','снег','облако','тело','лицо','семья','человек','люди','зубы','волосы','канал','кожура','выставка','пикник','шлюз','плесень','комар','муха','паук'}
...
def adj_adv(ru):
    ...
    return None
NL_PL_SKIP={'personeelszaken','spullen','openingstijden','overuren','kruiden','sieraden','boodschappen','burgerzaken','frietjes','chips','ouders','duinen','verzendkosten','servicekosten','notulen'}
ABSTRACT|={'приём','выборы','задача','условие','момент','мытьё','связь','протечка','выбор','запись','танец','отправление','прибытие','климат','поцелуй'}
BODY|={'почка','лёгкое','сердце','желудок','печень','кость','мышца','кровь'}
...
ANIM_M|={'внук','официант','повар','парикмахер','механик','электрик','сантехник','садовник','полицейский','пожарный',
 ...
 'певец','судья','декан','наставник','одноклассник','малыш','дошкольник','подросток','посетитель','господин','физиотерапевт'}
FEM_PERS|={'внучка','стюардесса','официантка','певица','королева','госпожа','дама','няня'}
VEL_TUPLE=tuple(VEL)
