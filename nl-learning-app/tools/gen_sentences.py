...
UNCNT={'лосось','тунец','скумбрия','селёдка','фарш','говядина','свинина','мороженое','жильё','виноград','клубника','кожа','картофель','интернет','одежда','пиво','природа','рис','сахар','масло','мясо','лук','лимонад','музыка','морковь','вода','кофе','чай','хлеб','сыр','суп','колбаса','салат','погода'}
INDECL={'радио':'n','фото':'n','резюме':'n','метро':'n','кафе':'n','евро':'m','кофе':'m','хобби':'n','боди':'n','какао':'n','меню':'n','портфолио':'n'}
MASC_A={'мужчина','дедушка','дядя','коллега'}
MASC_SOFT={'зять','учитель','водитель','пекарь','словарь','путь','картофель','отель','дождь','пароль','преподаватель','работодатель','родитель','день','гость','апостиль','локоть','ноготь'}
...
ANIMALS={'собака','кошка','лошадь','корова','свинья','овца','курица','птица','животное','рыба','лев','тигр','обезьяна','медведь','волк','лиса','кролик','олень','ёж','белка','утка','лебедь','гусь','сова','воробей','голубь','чайка','цапля','лягушка','змея','бабочка','пчела','оса','муравей','улитка','червяк','акула','дельфин','кит','тюлень','краб'}
PLACES={'школа','аптека','больница','супермаркет','рынок','вокзал','музей','парк','кафе','ресторан','магазин','офис','бассейн','кемпинг','отель','станция','центр','деревня','город','пляж','сад','кухня','спальня','ванная','гостиная','туалет','пекарня','аэропорт','порт','библиотека','сауна','стадион','прихожая','театр','кинотеатр','зоопарк','университет'}
...
VERB_OK={'zwemmen','lezen','schrijven','werken','spelen','koken','zingen','dansen','leren','slapen','wandelen','fietsen','sporten','voetballen','eten','drinken','betalen','helpen','luisteren','praten','spreken','reizen','tekenen','studeren','bellen','vragen','zeilen','vissen','schaatsen','winkelen','fotograferen','hardlopen','duiken','knutselen','stofzuigen','strijken','naaien','puzzelen','kamperen','bakken'}
DRINKS={'кофе','чай','молоко','вода','вино','пиво','сок','лимонад','пахта','какао','бульон'}
...
ADJ_SKIP={'злой','сердитый','больной','женатый','голодный','усталый','сытый','живой','старый','молодой','мёртвый','радостный','испуганный','довольный','весёлый','грустный','счастливый','занятой','оживлённый','свободный','целый','следующий','последний','первый','застенчивый','полосатый','клетчатый','однотонный','широкий','самостоятельный','присутствующий','отсутствующий','проснувшийся','непослушный','рождённый','помолвленный','разведённый','одинокий','двуязычный','гибкий','готовый','толстый','ленивый','любознательный','прилежный','светловолосый','лысый','терпеливый','подержанный','верный','жадный','ревнивый','опытный','мятый','изношенный'}
NEED_SKIP={'страна','сторона','провинция','север','юг','запад','восток','остров','деревня','город','лес','море','пляж','природа','погода','солнце','ветер','дождь','снег','облако','тело','лицо','семья','человек','люди','зубы','волосы','канал','кожура','выставка','пикник','шлюз','плесень','комар','муха','паук','пятно','диктант','пломба','коронка','трещина','дырка','капельница','наркоз','шов','гипс','вирус','бактерия','инфекция','пот','мороз','ливень','подлежащее','предлог','артикль','глагол','синоним','антоним','знак','апостроф','шпаргалка','прогул','неудовлетворительная','завещание','доверенность','алименты'}
FOOD_SKIP={'пачка','пакет','литр','грамм','кило','килограмм','фунт','марка','касса','чек','рынок','супермаркет','магазин','кухня','ложка','вилка','нож','тарелка','стакан','чашка','кастрюля','духовка','холодильник','стол','обед','ужин','завтрак','вид','сорт','половина','продавец','пекарь','мясник','бутылка','банка','счёт','цена','деньги','бронь','дегустация','чаевые','меню','буфет','снекбар','сковорода','доска','блендер','электрочайник','чайник','термос','ланчбокс','конфорка','вытяжка','плита','морозилка','противень','вок','сито','венчик','крышка','тёрка','половник','лопатка','открывалка','штопор','миксер','столешница'}
...
ABSTRACT|={'впечатление','мотивация','навык','рекомендация','происхождение','поведение','воспитание','наказание',
 'награда','отказ','переговоры','успех','прогресс','исправление','улучшение','гарантия','возврат','качество','черта',
 'сторона','нагрузка','выгорание','оплата','решение','планирование','инструкция','документация','передача',
 'регистрация','допуск','зачисление','пересдача','плата','уровень','продление','легализация','дискриминация',
 'равенство','знакомство','приветствие','прощание','визит','улыбка','сон','покой','дремота','орфография','слог',
 'глава','параграф','конспект','заметка','доклад','пример','стоимость','сдача','обучение','обмен','голосование',
 'пособие','направление','доза','давление','пульс','отёк','шум','дело','задачка','стирка','уборка','хранение',
 'расторжение','соглашение','договор','лечение','обследование','операция','диета','вес','рост','аллергия',
 'смена','служба','нетворк','талант','мода','ударение','культура','традиция','религия','свобода','история',
 'математика','география','биология','физика','лекция','церемония','политика','музыка'}
ADJ_ADV_MAP={'хороший':'хорошо','горячий':'горячо','свежий':'свежо'}
ADJ_END=('ый','ий','ой','ая','яя','ое','ее')
...
def adj_adv(ru):
    ...
    return None
NL_PL_SKIP={'personeelszaken','spullen','openingstijden','overuren','kruiden','sieraden','boodschappen','burgerzaken','frietjes','chips','ouders','duinen','verzendkosten','servicekosten','notulen','werkzoekende','zelfstandige','kosten','oordoppen','muesli','havermout','zomervakantie','herfstvakantie','leidinggevende','puberteit'}
ABSTRACT|={'приём','выборы','задача','условие','момент','мытьё','связь','протечка','выбор','запись','танец','отправление','прибытие','климат','поцелуй',
 'дедлайн','бюджет','компромисс','аргумент','дискуссия','ответственность','отставание','дружба','уверенность','зрение','слух','беременность','роды',
 'освобождение','рассрочка','взыскание','инкассо','помощь','процесс','торговля','мореплавание','рыболовство','промышленность','экономика','демократия','монархия',
 'гражданство','идентичность','интеграция','толерантность','уважение','норма','ценность','война','прошлое','будущее','век','самообслуживание','стиль','отбор',
 'назначение','форма','признание','эвакуация','методика','метод','семестр','карьера','переквалификация','повышение','кризис','состояние','опись','сквозняк',
 'изоляция','полоска','горошек','смех','настроение','терпение','смелость','страх','любовь','счастье','горе','надежда','желание','ложь','правда','секрет',
 'характер','акцент','голос','очередь','логистика','производство','оборот','прибыль','убыток','инвестиция','перевозка','зуд','бессонница','стресс',
 'каникулы','долг','мир','диарея','мигрень','перелом','растяжение','ожог','порез','шишка','хозяйство','зона','здоровье','усталость','уход','обязанность','экзамен','выражение','пословица','поговорка','вежливость','прямота','громкость','ритм','образ','питание','расслабление','спешка','рутина','юность','детство','поколение','брак','отрасль','торговля2','сплетня','объятие','стаж','членство','забастовка','опека','наследство','развод','смена имени','гололёд','осадки','прояснение','бережливость','велокультура','спряжение','исключение','сокращение','порядок','строение','страх','вручение','воспаление','заражение','одышка','головокружение','грудное вскармливание','давление сверстников','экранное время','оценка','балл','вскармливание','сбор','мысль','чувство','воспоминание','фантазия','реальность','усилие','сила','скорость','тишина','запах','жара','холод','тепло','оттепель','стужа','аппетит','посадка','восстановление'}
BODY|={'почка','лёгкое','сердце','желудок','печень','кость','мышца','кровь','борода','усы','локоть','запястье','лодыжка','бедро','щека','лоб','подбородок','шея','грудь','ноготь','губа','бровь','ресница','челюсть','ребро','кишечник'}
OVR.update({'взбитые сливки':('p','взбитые сливки','взбитые сливки'),'столовые приборы':('p','столовые приборы','столовые приборы'),
 'приёмные часы':('p','приёмные часы','приёмные часы'),'солнечные очки':('p','солнечные очки','солнечные очки'),
 'наручные часы':('p','наручные часы','наручные часы'),'лакричные конфеты':('p','лакричные конфеты','лакричные конфеты')})
ANIM_M|={'внук','официант','повар','парикмахер','механик','электрик','сантехник','садовник','полицейский','пожарный',
 'бухгалтер','переводчик','гид','турист','пилот','хирург','психолог','аптекарь','специалист','руководитель','соискатель',
 'стажёр','грузчик','уборщик','строитель','волонтёр','беженец','участковый','министр','премьер','король','художник',
 'певец','судья','декан','наставник','одноклассник','малыш','дошкольник','подросток','посетитель','господин','физиотерапевт','предприниматель','владелец','курьер','вор','прораб','бригадир','педиатр','логопед','сапожник','кандидат','свидетель','комендант','веломастер'}
FEM_PERS|={'внучка','стюардесса','официантка','певица','королева','госпожа','дама','няня','кассирша','акушерка'}
VEL_TUPLE=tuple(VEL)
...
def frames_for(theme_i,kind,disp,ru,lemma):
    ...
    if kind=='obj':
        ...
        if head not in ABSTRACT and head not in BODY:
        ...
        if theme_i==3 and head not in DRINKS and head not in FOOD_SKIP:  # еда
            ...
            if head in UNCNT or not countable:
                ...
                add('Wil je '+('' if head in UNCNT else 'een ')+B+'?','Хочешь '+P['a']+'?')
            else:
        ...
        if theme_i==7 and head not in ABSTRACT:
            add('Ik vind '+D+' leuk.','Мне '+('нравятся' if g=='p' else 'нравится')+' '+P['n']+'.')
    elif kind=='place':
...
def _run(bank,items,seen,fname,note):
  for ti,th in enumerate(bank):
    for wi,(disp,ru) in enumerate(th['w']):
        ...
        lemma=bare(disp)
        # предохранители: аббревиатуры/дефисы/многословные/запятые в переводе — не шаблонизируем
        if ',' in ru or ';' in ru or '(' in ru or '-' in lemma or ' ' in lemma or any(c.isupper() for c in lemma):continue
        if lemma in NL_PL_SKIP:continue
