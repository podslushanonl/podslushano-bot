...
MASC_SOFT={'зять','учитель','водитель','пекарь','словарь','путь','картофель','отель','дождь','пароль','преподаватель','работодатель','родитель','день','гость','апостиль'}
...
NEED_SKIP={'страна','сторона','провинция','север','юг','запад','восток','остров','деревня','город','лес','море','пляж','природа','погода','солнце','ветер','дождь','снег','облако','тело','лицо','семья','человек','люди','зубы','волосы','канал','кожура','выставка','пикник','шлюз','плесень','комар','муха','паук','пятно','диктант','пломба','коронка','трещина','дырка'}
FOOD_SKIP={'пачка','пакет','литр','грамм','кило','килограмм','фунт','марка','касса','чек','рынок','супермаркет','магазин','кухня','ложка','вилка','нож','тарелка','стакан','чашка','кастрюля','духовка','холодильник','стол','обед','ужин','завтрак','вид','сорт','половина','продавец','пекарь','мясник','бутылка','банка','счёт','цена','деньги','бронь','дегустация','чаевые','меню','буфет','снекбар','сковорода','доска','блендер','электрочайник','чайник','термос','ланчбокс'}
...
ABSTRACT|={'приём','выборы','задача','условие','момент','мытьё','связь','протечка','выбор','запись','танец','отправление','прибытие','климат','поцелуй',
 ...
 'каникулы','долг','мир','диарея','мигрень','перелом','растяжение','ожог','порез','шишка','хозяйство','зона','здоровье','усталость','уход','обязанность','экзамен','выражение','пословица','поговорка','вежливость','прямота','громкость','ритм','образ','питание','расслабление','спешка','рутина'}
BODY|={'почка','лёгкое','сердце','желудок','печень','кость','мышца','кровь','борода','усы'}
