...
_ARTICLE_SYSTEM = (
    ...
    "добраться, когда ехать, что рядом) — то, что реально интересно и полезно.\n"
    "• Где уместно — любопытные факты, контекст, короткие истории.\n"
    "• Структурируй: цепляющее вступление (1–2 абзаца), затем 3–6 разделов с "
    "подзаголовками, в конце — короткий вывод.\n\n"
