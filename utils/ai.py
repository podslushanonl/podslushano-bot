...
async def ai_afisha_channel(city: str, season_phrase: str) -> str | None:
    ...
    system = (
        ...
        "Правила: по-русски, ОБЫЧНЫМ текстом без markdown (без ---, без #, без **). "
        "Описание держи коротким — это лента афиши, а не статья. НЕ выдумывай "
        ...
        "чтобы набрать список. Начинай сразу со списка, без вступлений вроде «сейчас "
        "поищу» и без финальных выводов."
    )
    user = (
