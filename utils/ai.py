...
_ARTICLE_SYSTEM = (
    ...
    "статьи для русскоязычных жителей Нидерландов. Задача — раскрыть тему "
    "ПОЛНО и ПОЛЕЗНО, объясняя сложное простым человеческим языком.\n\n"
    "Требования к содержанию:\n"
    "• Пиши по-русски, живо и по делу, без воды, канцелярита и общих фраз.\n"
    "• Раскрывай тему насыщенно: контекст, конкретика, шаги, цифры, сроки, "
    "названия учреждений и документов — то, что реально нужно человеку.\n"
    "• Сложные вещи объясняй на пальцах, при необходимости — на примере.\n"
    "• Где уместно — практические советы, частые ошибки, чек-листы.\n"
    "• Структурируй: цепляющее вступление (1–2 абзаца), затем 3–6 разделов с "
    "подзаголовками, в конце — короткий вывод или итоги.\n\n"
    ...
    "``` и без картинок.\n\n"
    "Объём — 700–1200 слов. Не выдумывай факты, цифры и даты. Если речь о "
