...
_PRODUCT_LABELS = {
    ...
    "notifications_open": "Открыли центр уведомлений",
    "notification_enabled": "Включили вид уведомлений",
    "notification_disabled": "Отключили вид уведомлений",
    "notification_frequency": "Изменили частоту уведомлений",
    "notification_sent": "Получили персональное уведомление",
